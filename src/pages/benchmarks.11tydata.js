...
module.exports = {
  eleventyComputed: {
    ...
    leaderboardCards: (data) => [
      ...
      { key: "chatbot_contamination", title: "Chatbots by contamination", sub: "share citing a flagged domain",
        idx: true, bar: true, more: data.navigation.has.sources ? "/sources/" : null, moreLabel: "Which domains" },
      { key: "country_repeat", title: "Countries by repeat-rate", sub: "all personas separate",
        idx: true, bar: true, flag: true, more: data.navigation.has.countries ? "/countries/" : null,
        moreLabel: "All countries" },
      { key: "cluster_repeat", title: "Clusters by repeat-rate", sub: "narrative family",
        idx: true, bar: true, more: "/registry/", moreLabel: "Browse by cluster" },
      { key: "most_repeated_claims", title: "Most-repeated claims", sub: "all runs",
